<script>
  ...
  let minimum_price = productEditData.minimum_price
    ? parseFloat(productEditData.minimum_price)
    : "";
  let maximum_price = productEditData.maximum_price
    ? parseFloat(productEditData.maximum_price)
    : "";
  let measurement_unit = productEditData.measurement_unit
    ? productEditData.measurement_unit
    : "";

  let currency_id = productEditData.price_currency
    ? productEditData.price_currency.id
    : 1;
  ...
  $: minimum_price =
    typeof minimum_price === "number"
      ? parseFloat(minimum_price.toFixed(2))
      : minimum_price;
  $: maximum_price =
    typeof maximum_price === "number"
      ? parseFloat(maximum_price.toFixed(2))
      : maximum_price;
  ...
  $: categoryValidation = validateString(
    category,
    3,
    60,
    true,
  ...
  $: minimumPriceValidation = validatePrice(
    minimum_price,
    true,
    "Precio mínimo válido"
  );

  $: maximumPriceValidation = validatePrice(
    maximum_price,
    false,
    "Precio máximo válido"
  );

  $: measurementUnitValidation = validateString(
    measurement_unit,
    0,
    30,
    false,
  ...
  $: minimumPurchaseValidation = validateString(
    minimum_purchase,
    0,
    30,
    true,
  ...
  $: tariffHeadingValidation = validateString(
    tariff_heading,
    0,
    20,
    false,
    "Partida arancelaria válida"
  );

  $: validBeforeSubmit =
    nameValidation.isValid &&
    categoryValidation.isValid &&
    minimumPriceValidation.isValid &&
    maximumPriceValidation.isValid &&
    measurementUnitValidation.isValid &&
    minimumPurchaseValidation.isValid &&
    tariffHeadingValidation.isValid &&
...
<div class="ProductForm ProfileForm" id="ProductForm">
  ...
  <div class="ProductForm-headline">
    <h3 class="ProductForm-title">
      {ProductElement
        ? $_("productForm.updateProduct")
        : $_("productForm.addProduct")}
    </h3>
    ...
    {:else if !editMode}
      <p class="ProductForm-subtitle">{$_("productForm.uploadProductImage")}</p>
    {/if}
  </div>
  ...
  <div class="ProductForm-preview">
    <Dropzone
      ...
      imagePath={editMode &&
      ProductElement.principal_image &&
      !imagesToDelete.includes(ProductElement.principal_image.id)
        ? ProductElement.principal_image.path
        : null}
      allowDelete
      onDelete={() => {
        editMode && ProductElement.principal_image
          ? deleteImage(ProductElement.principal_image.id)
          : "";
      }}
    />
    <div class="productform-previewMini">
      <div>
        <Dropzone
          ...
          imagePath={editMode &&
          ProductElement.secondary_images[0] &&
          !imagesToDelete.includes(ProductElement.secondary_images[0].id)
            ? ProductElement.secondary_images[0].path
            : null}
          small="true"
          allowDelete
          onDelete={() => {
            editMode && ProductElement.secondary_images[0]
              ? deleteImage(ProductElement.secondary_images[0].id)
              : "";
          }}
        />
      </div>
      <div>
        <Dropzone
          ...
          imagePath={editMode &&
          ProductElement.secondary_images[1] &&
          !imagesToDelete.includes(ProductElement.secondary_images[1].id)
            ? ProductElement.secondary_images[1].path
            : null}
          small="true"
          allowDelete
          onDelete={() => {
            editMode && ProductElement.secondary_images[1]
              ? deleteImage(ProductElement.secondary_images[1].id)
              : "";
          }}
        />
      </div>
      <div>
        <Dropzone
          ...
          imagePath={editMode &&
          ProductElement.secondary_images[2] &&
          !imagesToDelete.includes(ProductElement.secondary_images[2].id)
            ? ProductElement.secondary_images[2].path
            : null}
          small="true"
          allowDelete
          onDelete={() => {
            editMode && ProductElement.secondary_images[2]
              ? deleteImage(ProductElement.secondary_images[2].id)
              : "";
          }}
        />
      </div>
  ...
  <form class="ProductForm-form ProfileForm-form">
    <div class="form-group">
      <Textfield
        ...
        variant="outlined"
        bind:value={name}
        label={$_("productForm.nameOfTheProduct")}
      ...
      <HelperText
        id="product-name"
        persistent={name && !nameValidation.isValid}
      >
    ...
    <div class="form-group">
      <Select
        ...
        variant="outlined"
        bind:value={category}
        label={$_("productForm.categoryOfTheProduct")}
        invalid={category && !categoryValidation.isValid}
      >
        <Option value="" />
    ...
    <div class="form-group">
      <div class="form-group-two">
        <Textfield
          ...
          label={$_("productForm.minimumPrice")}
        ...
        <Textfield
          ...
          label={$_("productForm.maximumPrice")}
    ...
    <div class="form-group">
      <Textfield
        ...
        label={$_("productForm.tariffHeading")}
      ...
      <HelperText
        persistent={tariff_heading && !tariffHeadingValidation.isValid}
      >
    ...
    <div class="form-group">
      <Textfield
        ...
        label={$_("productForm.unitOfMesurement")}
      ...
      <HelperText
        persistent={measurement_unit && !measurementUnitValidation.isValid}
      >
    ...
    <div class="form-group">
      <Textfield
        ...
        label={$_("productForm.minimumPurchase")}
      ...
      <HelperText
        persistent={minimum_purchase && !minimumPurchaseValidation.isValid}
      >
    ...
    <div class="form-group">
      <Textfield
        ...
        label={$_("productForm.productCertifications")}
        input$aria-controls="product-name"
        input$aria-describedby="product-name"
        input$maxlength="50"
      />
