...
<div class="Home">
  ...
  >
    <span
      class="Home-Authentication-close"
      on:click={() => (homeAuthenticationOpen = false)}>
    ...
    <div class="Home-features-content">
      <div class="Home-feature">
        ...
        <div class="Home-feature-image">
          <figure class="Home-feature-image-mobile">
            <img
              class="Home-feature-image-device"
              src="images/feature-device-1.png"
              alt="Device"
            />
            <img
              class="Home-feature-image-screenshot"
              src="images/feature-ss-1.png"
              alt="Screenshot"
            />
          </figure>
        </div>
      ...
      <div class="Home-feature">
        ...
        <div class="Home-feature-image">
          <figure class="Home-feature-image-laptop">
            <img
              class="Home-feature-image-device"
              src="images/feature-device-2.png"
              alt="Device"
            />
            <img
              class="Home-feature-image-screenshot"
              src="images/feature-ss-2.png"
              alt="Screenshot"
              style="top:auto;"
            />
          </figure>
      ...
      <div class="Home-feature">
        ...
        <div class="Home-feature-image">
          <figure>
            <img
              class="Home-feature-image-security"
