<script>
    ...
    onMount(async () => {
        ...
        marketBannerElement.style.backgroundImage = `${backgroundGradient}, url(${imageSrc})`;
    });
</script>
...
<div id={marketBannerElementName} class="MarketBanner">
    <h3 class="MarketBanner-title">Bienvenido a la nueva forma de conocer clientes, proveedores y aliados.</h3>
